...
function AddCategoryScreen({navigation, route}) {
  ...
  return (
    <View style={styles.shell}>
      ...
      <Modal isVisible={modalSuccess} onBackdropPress={visibilityModalDelete}>
      ...
      <Modal isVisible={modalDelete} onBackdropPress={visibilityModalDelete}>
        <View style={styles.modalConfirm}>
          <Text style={styles.textSales}>Anda yakin hapus kategori ini?</Text>
          ...
          <View
            ...
            <TouchableOpacity
              ...
              {isLoading ? (
                ...
                <Text style={{fontWeight: '500', color: 'white'}}>Ya</Text>
              )}
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => visibilityModalDelete()}
